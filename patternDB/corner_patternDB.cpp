...
corner_patternDB::corner_patternDB() : patterDBstucture(100179840) {}

corner_patternDB::corner_patternDB(uint8_t init_val) : patterDBstucture(100179840, init_val) {}

uint32_t corner_patternDB::getDatabaseIndex(const generic_cube &cube) const {
